...
class Stats:
    ...
    def __init__(self, fname='dht.txt',OUTPUT_FOLDER='Python/',  sname='stats.xlsx', kategooria=kategooriad_py):
        ...
        # Kategooria peaks algama suure tähega
        self.kategooriad = kategooria  # Kategooriad tuleb viia eraldi faili.
...
if __name__=='__main__':
    # def __init__(self, fname='dht.txt',OUTPUT_FOLDER='Python/',  sname='stats.xlsx', kategooria=kategooriad_py):
    print('Kombain')
    sts = stat_full('dht_proto.txt', 'proto/', kategooria=kategooriad_py)  # Python
...
with open('sõnastats.txt',encoding='utf-8') as f:
	a=json.load(f)
# """
# Kategooriad tuleb viia eraldi faili.
